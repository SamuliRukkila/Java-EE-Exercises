# Part 4 assignments - Spring & Liferay

### #1 Sprint console-application (DI & AOP)

In this assignment we'll create a simple application where we demonstrate depositing and withdrawing money
