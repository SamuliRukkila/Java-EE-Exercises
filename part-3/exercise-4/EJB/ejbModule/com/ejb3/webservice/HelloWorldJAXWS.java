/*
 ...
 EJB (Enterprise Java bean) is server-side component. They encapsulate
 ...
 * requests from the client. These requests will be forwarded to service and
 * then back to the caller. 
 * 
 * It's @Stateless so it's state won't be sessioned. Class 
 * is also @LocalBean, meaning it has no interface -view
 * 
 * @author samuli
 */
@WebService
...
public class HelloWorldJAXWS {
   ...
   * 
   * @param Saved book as an Book-object
